...
class BaseDatos extends PDO {
    ...
    /**
     * Si se inserta en una tabla que tiene una columna autoincrement se retorna el id 
     * con el que se inserto el registro caso contrario se retorna -1
     */
    ...
    private function EjecutarDeleteUpdate($sql) {
        ...
        try {
            ...
            //echo $e->getMessage();
            //  throw new PDOException("Error al ejecutar:: ".$sql);
            $this->analizarDebug();
